...
class Organization:
    ...
    def retrieve_by(name: str) -> list['Organization']:
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/organizations/search?fields=name&term={name}&api_token={API_KEY}'
    ...
    def create(**kwargs) -> 'Organization':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/organizations?api_token={API_KEY}'
...
class Person:
    ...
    def retrieve_by(email: str) -> list['Person']:
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/persons/search?fields=email&term={email}&api_token={API_KEY}'
    ...
    def create(**kwargs) -> 'Person':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/persons?api_token={API_KEY}'
...
class Deal:
    ...
    def create(**kwargs) -> 'Deal':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/deals?api_token={API_KEY}'
    ...
    def get_all_deals() -> list['Deal']:
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/deals?limit=500&api_token={API_KEY}'
    ...
    def update(self, **kwargs) -> 'Deal':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/deals/{self.id}?api_token={API_KEY}'
...
class Activity:
    ...
    def create(**kwargs) -> 'Activity':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/activities?api_token={API_KEY}'
    ...
    def get_all_activities() -> list['Activity']:
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/activities?limit=500&api_token={API_KEY}'
    ...
    def update(self, **kwargs) -> 'Activity':
        ...
        url = f'https://{COMPANY_DOMAIN}.pipedrive.com/api/v1/activities/{self.id}?api_token={API_KEY}'
